  ...
  return (
    <>
      <div class="noticecontainer">
        <h1 class="noticeheading">Testing</h1>
        <ul class="noticelist">
          <li class="noticelist-item">
            👍if user entered wrong Bank details khatri 555 is not responsible.
          </li>
          <li class="noticelist-item">
        ...
        <div className="divider" />
        <h1 class="noticeheading">Unfair - Bets</h1>
        <ul class="noticelist">
          <li class="noticelist-item2">
            If admin found any unfair bets blocking of digits,canning or match
            fix bets.
          </li>
          <li class="noticelist-item2">
            Admin has all rights to take necessary actions to block the users.
          </li>
        </ul>
        <div className="divider" />
        <h1 class="noticeheading">Cheating - Bets</h1>
        <ul class="noticelist">
          <li class="noticelist-item2">
            If admin found any cheating,hacking,phishing.Admin has all right to
            take necessary actions to block the user
          </li>
        </ul>
      </div>
    </>
